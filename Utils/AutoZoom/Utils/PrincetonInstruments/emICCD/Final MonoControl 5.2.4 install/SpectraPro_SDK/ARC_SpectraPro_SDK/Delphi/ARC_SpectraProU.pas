...
var
 ...
 Local_ARC_move_Mono_Slit          : TARC_move_Mono_Slit;
...
if ARC_SpectraPro <> 0 then begin
     //Communications
     ...
     @Local_ARC_move_Mono_Slit := GetProcAddress(ARC_SpectraPro, 'ARC_move_Mono_Slit');
     ...
     if //Communications
        ...
        and         (@Local_ARC_Open_Mono <> nil)
         and         (@Local_ARC_Open_Mono_Port <> nil)
         and         (@Local_ARC_Close_Mono <> nil)
         and         (@Local_ARC_Valid_Mono_Enum <> nil)
         and         (@Local_ARC_get_Mono_preOpen_Model <> nil)
         and         (@Local_ARC_get_Mono_preOpen_Model_int32 <> nil)
         and         (@Local_ARC_Ver <> nil)
          // direct communications function
         and        (@Local_ARC_Send_CMD_To_Mono <> nil)
         //Information
         and         (@Local_ARC_get_Mono_Model <> nil)
         and         (@Local_ARC_get_Mono_Serial <> nil)
         and         (@Local_ARC_get_Mono_Focallength <> nil)
         and         (@Local_ARC_get_Mono_HalfAngle <> nil)
         and         (@Local_ARC_get_Mono_DetectorAngle <> nil)
         and         (@Local_ARC_get_Mono_Double <> nil)
         and         (@Local_ARC_get_Mono_Double_Subtractive <> nil)
         and         (@Local_ARC_get_Mono_Precision <> nil)
         // CCD Pixel Mapping
         and (@Local_ARC_get_Mono_Pixel_Map_nm <> nil)
         and         (@Local_ARC_get_Mono_Pixel_Map_ang <> nil)
         and         (@Local_ARC_get_Mono_Pixel_Map_eV <> nil)
         and         (@Local_ARC_get_Mono_Pixel_Map_micron <> nil)
         and         (@Local_ARC_get_Mono_Pixel_Map_absCM <> nil)
         and         (@Local_ARC_get_Mono_Pixel_Map_relCM <> nil)

          // Wavelength
         and (@Local_ARC_get_Mono_Wavelength_nm <> nil)
         and        (@Local_ARC_set_Mono_Wavelength_nm <> nil)
         and        (@Local_ARC_get_Mono_Wavelength_ang <> nil)
         and        (@Local_ARC_set_Mono_Wavelength_ang <> nil)
         and        (@Local_ARC_get_Mono_Wavelength_eV <> nil)
         and        (@Local_ARC_set_Mono_Wavelength_eV <> nil)
         and        (@Local_ARC_get_Mono_Wavelength_micron <> nil)
         and        (@Local_ARC_set_Mono_Wavelength_micron <> nil)
         and        (@Local_ARC_get_Mono_Wavelength_absCM <> nil)
         and        (@Local_ARC_set_Mono_Wavelength_absCM <> nil)
         and        (@Local_ARC_get_Mono_Wavelength_relCM <> nil)
         and        (@Local_ARC_set_Mono_Wavelength_relCM <> nil)
         and        (@Local_ARC_get_Mono_Wavelength_Cutoff_nm <> nil)
         and        (@Local_ARC_get_Mono_Wavelength_Min_nm <> nil)

         // Grating
         and (@Local_ARC_get_Mono_Turret <> nil)
         and        (@Local_ARC_set_Mono_Turret <> nil)
         and        (@Local_ARC_get_Mono_Turret_Gratings <> nil)
         and        (@Local_ARC_get_Mono_Turret_Max <> nil)
         and        (@Local_ARC_get_Mono_Grating <> nil)
         and        (@Local_ARC_set_Mono_Grating <> nil)
         and        (@Local_ARC_get_Mono_Grating_Blaze <> nil)
         and        (@Local_ARC_get_Mono_Grating_Density <> nil)
         and        (@Local_ARC_get_Mono_Grating_Installed <> nil)
         and        (@Local_ARC_get_Mono_Grating_Max <> nil)

         // Mirrors
         and (@Local_ARC_get_Mono_Diverter_Valid <> nil)
         and        (@Local_ARC_get_Mono_Diverter_Pos <> nil)
         and         (@Local_ARC_set_Mono_Diverter_Pos <> nil)
         and         (@Local_ARC_get_Mono_Diverter_Pos_Var <> nil)

          // Slits
         and (@Local_ARC_get_Mono_Slit_Type <> nil)
         and         (@Local_ARC_get_Mono_Slit_Type_Var <> nil)
         and         (@Local_ARC_get_Mono_Slit_Width <> nil)
         and         (@Local_ARC_move_Mono_Slit <> nil)
         and         (@Local_ARC_set_Mono_Slit_Width <> nil)
         and         (@Local_ARC_Mono_Slit_Home <> nil)
         and         (@Local_ARC_Mono_Slit_Name_Var <> nil)
         and         (@Local_ARC_Calc_Mono_Slit_BandPass <> nil)
         and         (@Local_ARC_get_Mono_Slit_BandPass <> nil)
         and         (@Local_ARC_set_Mono_Slit_BandPass <> nil)

         // Special Double Function
         and (@Local_ARC_get_Mono_Double_Intermediate_Slit <> nil)
         and         (@Local_ARC_get_Mono_Exit_Slit <> nil)

         // Filter
         and (@Local_ARC_get_Mono_Filter_Present <> nil)
         and         (@Local_ARC_get_Mono_Filter_Position <> nil)
         and         (@Local_ARC_set_Mono_Filter_Position <> nil)
         and         (@Local_ARC_get_Mono_Filter_Min_Pos <> nil)
         and         (@Local_ARC_get_Mono_Filter_Max_Pos <> nil)
         and         (@Local_ARC_Mono_Filter_Home <> nil)

         // advanced functions
         // Gear
         and (@Local_ARC_get_Mono_Int_Led_On <> nil)
         and         (@Local_ARC_set_Mono_Int_Led <> nil)
         and         (@Local_ARC_get_Mono_Motor_Int <> nil)
         and         (@Local_ARC_get_Mono_Wheel_Int <> nil)
         and         (@Local_ARC_Mono_Move_Steps <> nil)


         // Grating Values
         and (@Local_ARC_get_Mono_Init_Grating <> nil)
         and         (@Local_ARC_set_Mono_Init_Grating <> nil)
         and         (@Local_ARC_get_Mono_Init_Wave_nm <> nil)
         and         (@Local_ARC_set_Mono_Init_Wave_nm <> nil)
         and         (@Local_ARC_get_Mono_Init_ScanRate_nm <> nil)
         and         (@Local_ARC_set_Mono_Init_ScanRate_nm <> nil)
         and         (@Local_ARC_get_Mono_Grating_Offset <> nil)
         and         (@Local_ARC_get_Mono_Grating_Gadjust <> nil)
         and         (@Local_ARC_set_Mono_Grating_Offset <> nil)
         and         (@Local_ARC_set_Mono_Grating_Gadjust <> nil)
         and         (@Local_ARC_Mono_Grating_Calc_Offset <> nil)
         and         (@Local_ARC_Mono_Grating_Calc_Gadjust <> nil)
         and         (@Local_ARC_Mono_Grating_UnInstall <> nil)
         and         (@Local_ARC_Mono_Grating_Install <> nil)
         and         (@Local_ARC_Mono_Reset <> nil)
         and         (@Local_ARC_Mono_Restore_Factory_Settings <> nil)
         and         (@Local_ARC_Mono_Save_Factory_Settings <> nil)

         // Scan Values
         and (@Local_ARC_get_Mono_Scan_Rate_nm_min <> nil)
         and         (@Local_ARC_set_Mono_Scan_Rate_nm_min <> nil)
         and         (@Local_ARC_Mono_Start_Scan_To_nm <> nil)
         and         (@Local_ARC_Mono_Scan_Done <> nil)
         and         (@Local_ARC_Mono_Start_Jog <> nil)
         and         (@Local_ARC_Mono_Stop_Jog <> nil)

         // Serial Number Integers
         and (@Local_ARC_get_Filter_Serial_int32 <> nil)
         and (@Local_ARC_get_Mono_Serial_int32 <> nil)

                 // Pre Open Serial Number Integers
         and (@Local_ARC_get_Filter_preOpen_Serial_int32 <> nil)
         and (@Local_ARC_get_Mono_preOpen_Serial_int32 <> nil)
     then begin
...
function ARC_move_Mono_Slit(Mono_Enum : integer; Slit_Pos : integer; steps : integer) : wordbool;
begin
  result := local_ARC_move_Mono_Slit(Mono_Enum, Slit_Pos, steps);
end;
