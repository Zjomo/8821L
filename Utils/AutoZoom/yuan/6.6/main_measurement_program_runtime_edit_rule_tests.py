...
from logic.actual_nano_boundary_following_sam2VideoAB_xyStep_detailed import RuntimeConfig as RuleABRuntimeConfig
from logic.actual_nano_boundary_following_sam2VideoAB_xyStep_detailed import ActualNanoBoundaryFollower
    ...
    def test_rule_ab(self):
        ...
        def _apply_rule_ab_runtime_ui_params(frame_tag: str = "") -> Dict[str, Any]:
            ...
            for name in (
                ...
                if hasattr(fc, short):
                    setattr(fc, short, getattr(live_cfg, name))
            ...
            if seg is not None:
                ...
                for seg_attr, cfg_attr in mapping.items():
                    if hasattr(seg, seg_attr):
                        try:
                            setattr(seg, seg_attr, getattr(live_cfg, cfg_attr))
                        except Exception:
                            pass
