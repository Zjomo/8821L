...
class ActualNanoBoundaryFollower:
    ...
    def rule_policy(self, scene: SceneGeometry) -> int:
        ...
        # C 局部切向方向。follow_c_direction=1/-1 用于切换绕行方向。
        ...
        # --------------------------------------------------------
        # 4. A-C OK：只沿 C 的局部切向运动。
        #    这里故意不再使用 a_c_target_clearance 做小修正。
        # --------------------------------------------------------
        return vector_to_action(tangent)
