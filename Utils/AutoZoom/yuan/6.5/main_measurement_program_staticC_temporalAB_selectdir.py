...
from logic.actual_nano_boundary_following_staticC_temporalAB_selectdir import RuntimeConfig as RuleABRuntimeConfig
from logic.actual_nano_boundary_following_staticC_temporalAB_selectdir import ActualNanoBoundaryFollower
...
class MeasurementConfig:
    ...
    rule_ab_a_temporal_score_weight: float = float(_cfg("rule_ab_a_temporal_score_weight", 0.35))
    rule_ab_a_temporal_iou_weight: float = float(_cfg("rule_ab_a_temporal_iou_weight", 0.35))
    rule_ab_a_temporal_area_weight: float = float(_cfg("rule_ab_a_temporal_area_weight", 0.15))
    rule_ab_a_temporal_center_weight: float = float(_cfg("rule_ab_a_temporal_center_weight", 0.10))
    rule_ab_a_temporal_c_leak_weight: float = float(_cfg("rule_ab_a_temporal_c_leak_weight", 0.25))
    rule_ab_a_temporal_center_sigma_px: float = float(_cfg("rule_ab_a_temporal_center_sigma_px", 80.0))
    rule_ab_a_temporal_area_ratio_min: float = float(_cfg("rule_ab_a_temporal_area_ratio_min", 0.50))
    rule_ab_a_temporal_area_ratio_max: float = float(_cfg("rule_ab_a_temporal_area_ratio_max", 1.80))
    rule_ab_a_temporal_max_c_unique_leak_ratio: float = float(_cfg("rule_ab_a_temporal_max_c_unique_leak_ratio", 0.35))
    rule_ab_a_temporal_fallback_to_last_if_bad: bool = bool(_cfg("rule_ab_a_temporal_fallback_to_last_if_bad", True))
    rule_ab_a_temporal_min_accept_score: float = float(_cfg("rule_ab_a_temporal_min_accept_score", 0.15))
    ...
    rule_ab_b_temporal_score_weight: float = float(_cfg("rule_ab_b_temporal_score_weight", 0.35))
    rule_ab_b_temporal_iou_weight: float = float(_cfg("rule_ab_b_temporal_iou_weight", 0.35))
    rule_ab_b_temporal_area_weight: float = float(_cfg("rule_ab_b_temporal_area_weight", 0.15))
    rule_ab_b_temporal_center_weight: float = float(_cfg("rule_ab_b_temporal_center_weight", 0.10))
    rule_ab_b_temporal_c_leak_weight: float = float(_cfg("rule_ab_b_temporal_c_leak_weight", 0.25))
    rule_ab_b_temporal_center_sigma_px: float = float(_cfg("rule_ab_b_temporal_center_sigma_px", 80.0))
    rule_ab_b_temporal_area_ratio_min: float = float(_cfg("rule_ab_b_temporal_area_ratio_min", 0.50))
    rule_ab_b_temporal_area_ratio_max: float = float(_cfg("rule_ab_b_temporal_area_ratio_max", 1.80))
    rule_ab_b_temporal_max_c_unique_leak_ratio: float = float(_cfg("rule_ab_b_temporal_max_c_unique_leak_ratio", 0.35))
    rule_ab_b_temporal_fallback_to_last_if_bad: bool = bool(_cfg("rule_ab_b_temporal_fallback_to_last_if_bad", True))
    rule_ab_b_temporal_min_accept_score: float = float(_cfg("rule_ab_b_temporal_min_accept_score", 0.15))
