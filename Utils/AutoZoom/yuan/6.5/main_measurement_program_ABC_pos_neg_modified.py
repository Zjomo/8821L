...
from logic.actual_nano_boundary_following_yoloA_sam2BC_ABC_pos_neg_bodyedge import RuntimeConfig as RuleABRuntimeConfig
from logic.actual_nano_boundary_following_yoloA_sam2BC_ABC_pos_neg_bodyedge import ActualNanoBoundaryFollower
...
class MeasurementConfig:
    ...
    rule_ab_c_quadrilateral_method: str = str(_cfg("rule_ab_c_quadrilateral_method", "approx_first"))
    ...
    def test_rule_ab(self):
        ...
        try:
            ...
            c_quadrilateral_method = str(
                getattr(cfg_gui, "rule_ab_c_quadrilateral_method", "approx_first")
            )
            ...
            self.log(
                ...
                f"a_c_correction_mode=horizontal_from_c_center, "
            ...
            rule_cfg = RuleABRuntimeConfig(
                ...
                # 当前实验画面中，A-C 太近/太远时应优先按水平方向修正，
                # 避免最近边界法向落到 C 的上下边而持续输出 UP/DOWN。
                a_c_correction_mode="horizontal_from_c_center",
