...
from logic.rule_ab_follow_c_static_c import RuntimeConfig as RuleABRuntimeConfig
from logic.rule_ab_follow_c_static_c import ActualNanoBoundaryFollower
...
class MeasurementWorkflowGUI:
    ...
    def _build_ui(self):
        ...
        ttk.Button(rule_buttons, text="单独A沿C绕行(多点SAM2)", command=self.test_rule_ab_thread).grid(row=0, column=0, padx=4, pady=3, sticky="ew")
