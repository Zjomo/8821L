...
class MeasurementWorkflowGUI:
    ...
    def sync_config_from_ui_to_workflow(self) -> MeasurementWorkflow:
        ...
        if loaded_state is not None:
            ...
            # 完整测量运行中，Step7/Step9 必须使用锁定的完整标定 C，
            # 不能被 GUI 单独测试区残留的 C 文件夹覆盖。
    ...
    def run_workflow(self):
        ...
        try:
            ...
            self.root.after(0, lambda: self.rule_ab_enable_stage_var.set(True))
            self.root.after(0, lambda: self.rule_ac_enable_stage_var.set(True))
