...
class MeasurementWorkflow:
    ...
    def begin_step9_run_session(self) -> Path:
        ...
        for sub in ("frames", "masks", "overlays", "b_initial"):
        ...
        meta = {
            ...
            "static_c_map_dir": str(getattr(self.cfg, "rule_ab_static_c_map_dir", "")),
        }
        try:
...
class MeasurementWorkflowGUI:
    ...
    def test_rule_ac(self):
        ...
        新逻辑：
            ...
            3. 每次点击都会新建一个 Step9 run 文件夹保存过程结果；
            4. 测试开始时调用 SAM2 对 B 进行初始分割；
            5. 后续每帧继续用 SAM2 更新 B；
