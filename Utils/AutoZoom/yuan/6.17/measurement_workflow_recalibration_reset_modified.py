...
class MeasurementWorkflowGUI:
    ...
    def _build_ui(self):
        ...
        ttk.Button(button_grid, text="1 标定上层BN", command=self.calibrate_angle_b_thread).grid(row=2, column=0, padx=4, pady=4, sticky="ew")
        ttk.Button(button_grid, text="2 标定 卍", command=self.calibrate_rule_ab_a_thread).grid(row=2, column=1, padx=4, pady=4, sticky="ew")
        ttk.Button(button_grid, text="2b 标定上层BN", command=self.calibrate_rule_ab_b_thread).grid(row=3, column=0, padx=4, pady=4, sticky="ew")
        ttk.Button(button_grid, text="3 标定下层BN", command=self.calibrate_global_c_thread).grid(row=3, column=1, padx=4, pady=4, sticky="ew")
