...
class MeasurementWorkflow:
    ...
    def _start_labview_tcp_server_compat(self, server: Any):
        ...
        for name in start_method_names:
            ...
            # start/start_server 通常会自己开线程，也可能阻塞；统一放到守护线程里，避免卡住 GUI。
        ...
        self.log(
            "[TCP] LabVIEWTCPServer 未提供 start/start_server/run/serve_forever/listen/open；"
            "已保留实例并继续运行。若该类不是构造即启动，请在 control/labview_tcp_server.py "
            "中增加 start() 或 start_server() 方法。"
        )
